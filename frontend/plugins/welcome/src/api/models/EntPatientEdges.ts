...
export interface EntPatientEdges {
     ...
     * @memberof EntPatientEdges
     */
    patientToTriageResult?: Array<EntTriageResult>;
    /**
     * 
     * @type {EntPrefix}
     * @memberof EntPatientEdges
...
export function EntPatientEdgesFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntPatientEdges {
    ...
    return {
        ...
        'patientToTriageResult': !exists(json, 'patientToTriageResult') ? undefined : ((json['patientToTriageResult'] as Array<any>).map(EntTriageResultFromJSON)),
...
export function EntPatientEdgesToJSON(value?: EntPatientEdges | null): any {
    ...
    return {
        ...
        'patientToTriageResult': value.patientToTriageResult === undefined ? undefined : ((value.patientToTriageResult as Array<any>).map(EntTriageResultToJSON)),
